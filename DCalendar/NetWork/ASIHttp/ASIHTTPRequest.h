...
typedef void (^ASIDidRequestFinished)(NSData *receData, NSError *error); //add by shizejing 2014-11-5
...
@property (nonatomic, copy) ASIDidRequestFinished didRequestFinishedBlock;
